...
# JWT Configuration
SECRET_KEY = settings.JWT_SECRET_KEY if settings.JWT_SECRET_KEY is not None else os.getenv("SECRET_KEY")
...
# Use a deterministic fallback only for non-production to avoid runtime JWSError
if not SECRET_KEY:
